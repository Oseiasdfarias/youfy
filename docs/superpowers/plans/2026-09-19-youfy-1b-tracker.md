...
- [x] **Task 1: MLflow local e o contrato do artefato**
...
- [x] **Task 2: `ml.dataset` — leitura dos arrays com rótulos**
...
- [x] **Task 3: `ml.model` — a CNN e o semeador determinístico**
...
- [x] **Task 4: `ml.train` — loop de treino e as duas propriedades de ML**
...
- [x] **Task 5: `ml.evaluate` — métricas e o teste de rótulos embaralhados**
...
- [x] **Task 6: `ml.promotion` — o gate codificado**
...
- [x] **Task 7: `ml.tracking` — run do MLflow e registro por alias**
...
- [x] **Task 8: `serving` — carga do registry com validação de FeatureSpec**
...
- [x] **Task 9: CLI `train` e `evaluate`, e2e do 1B e CI**
